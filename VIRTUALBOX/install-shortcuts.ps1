...
# -----------------------------------------------------------------------
# Tarefa agendada: desabilita adaptadores e servicos VirtualBox a cada boot
...
$bootTaskName = 'ServiceControl_VirtualBox_DisableAdaptersOnBoot'
...
try {
    Register-ScheduledTask `
        ...
        -Description 'Service Control: desabilita servicos e adaptadores VirtualBox a cada boot' `
