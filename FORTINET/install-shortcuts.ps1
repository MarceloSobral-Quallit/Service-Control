...
# -----------------------------------------------------------------------
# Tarefa agendada: desabilita adaptadores e servicos Fortinet a cada boot
...
$bootTaskName = 'ServiceControl_Fortinet_DisableAdaptersOnBoot'
...
try {
    Register-ScheduledTask `
        ...
        -Description 'Service Control: desabilita servicos e adaptadores Fortinet a cada boot' `
